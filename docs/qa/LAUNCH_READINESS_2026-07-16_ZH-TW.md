...
- [x] 補齊 12 個語系的版本更新說明。
- [x] 將 12 個語系 App 描述改為符合目前帳號、Pro 與週／年／永久付費模式的內容。
- [ ] 人工抽查 App 描述、截圖、付費功能與實際 App 顯示一致。
- [x] 已建立 [App Review 備註草稿](../app-store/APP_REVIEW_NOTES_1.0.4_ZH-TW.md)，涵蓋加入鍵盤、完整取用、複製、生成、填入與 Paywall 路徑。
- [ ] 建立 demo 帳號後，把帳密與備註貼入 App Store Connect 並人工核對。
- [ ] 若需要登入，附 demo 帳號。
...
| 實體 iPhone 第三方鍵盤 | 未通過 |
| Sandbox 付款與恢復購買 | 未通過 |
| App Store 1.0.4 送審資料 | 部分完成；多語系文案已完成，demo 帳號、審核備註與隱私資料待人工確認 |
| 真實買量歸因 | 未完成 |
| Android 正式版資格 | 未完成 |
