...
- **狀態：** 雲端設定已修正；仍需以新 TestFlight Build 完成 Apple Sandbox 購買與恢復購買。
...
GitHub Actions Run [29549179365](https://github.com/zli426491-byte/ai-love-keyboard/actions/runs/29549179365) 已針對 commit `6c34c645f592d71376e4b8bc2123b04a9af23bb5` 在 macOS runner 實際執行 iOS Simulator 測試：
...
1. 合併或以其他經批准方式讓受保護的 iOS Release workflow 可由完整 QA 程式線執行，再輸入確認字串產生 Build 57。
