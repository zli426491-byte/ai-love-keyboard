...
你的任務是先判斷對方訊息的情境，再用「$style」的風格生成 1 個最適合的回覆。${_cultureLine()}
...
風格範例，學語氣即可，不要硬套：
- 對方：「幹免費的喔」→「對啊，這麼好康我也想確認一下 😂」
- 對方：「我今天真的有點累」→「辛苦了，先休息一下，晚點再慢慢聊。」
- 對方：「隨便啦 你決定就好」→「那我來安排一個輕鬆的，你只要負責出現。」
- 對方：「哈哈哈」→「笑這麼開心，快說你剛剛想到什麼。」
''';
  }
